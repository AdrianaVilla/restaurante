...
# Panel costos
panel_costos = Frame(panel_izquiero, bd=1, relief=FLAT, bg="azure4", padx=63)
panel_costos.pack(side=BOTTOM)

# Panel de comidas
panel_comidas = LabelFrame(panel_izquiero, text="Comidas", font=("Dosis", 19, "bold",),
...
lista_postres = ["Helado", "Fruta", "Brownies", "Flan", "Mouss", "Pastel1", "Pastel2", "Pastel3"]
...
botones_guardados[15].config(comman=lambda : click_boton("/"))
